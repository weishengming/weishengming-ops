...
"""
auto deploying java web application for clientservice-bootstrap
command examples:
fab deploy_live
fab rollback_beta
run 'fab -l' for more
...
project_owner = 'clientservice-bootstrap';
project_home = '/home/github/weishengming-client/clientservice-bootstrap/';
